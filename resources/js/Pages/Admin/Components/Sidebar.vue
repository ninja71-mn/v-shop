<template>
    <aside
        class="fixed top-0 md:rtl:right-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0"
        aria-label="Sidenav"
            ...
            >
                <li>
                    ...
                    >
                        ...
                        <span class="mr-3">گزارش فروش</span>
                    </a>
                </li>
